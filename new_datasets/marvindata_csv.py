...
class MarvinDatasetCSV(Dataset):
    ...
    def __init__(
        ...
        super(MarvinDatasetCSV, self).__init__()
    ...
    def get_data(self, idx):
        ...
        semantic_column = "semantic_with_nodes"

        if not self.cache:
            # data = torch.load(data_path)
            import pandas as pd
            fields = ["x", "y", "z", "blue", "green", "red", "nx", "ny", "nz", "semantic", "semantic_with_nodes"]
